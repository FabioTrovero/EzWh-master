...
function testGetItem(agent,itemid, supplierId, myexpitem, expCode){
...
function testGetItemnotfound(agent, id, supplierId, expCode){
    describe('get /api/items/:id/:supplierId', function(){
        it('Gettim item details', function(done){
...
function testEditItem(agent, ith, supplierId, newDescription, newPrice, myexpitem, expCode){
    describe(' put /api/item/:id/:supplierId', function(){
        it('Modify an item given its ID and new fields', function(done){
            agent.put('/api/item/'+ith+'/'+supplierId)

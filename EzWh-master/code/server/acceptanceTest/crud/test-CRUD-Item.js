...
function testItemCRUD(){
    ...
    describe('Test Item CRUD features', () => {
        ...
        items.testGetItem(agent, 0, 0, myitems[0], 200);
        items.testGetItemnotfound(agent, null, 0, 422);
        items.testGetItemnotfound(agent, 0, 1000, 422);
        items.testGetItemnotfound(agent, 0, null, 422);
        items.testGetItemnotfound(agent, 100000000, 0, 404);
        items.testEditItem(agent, 0, 0, 'desc0', 99.99, myedititem, 200);
        items.testDeleteItem(agent, 0, 0, 204);
        items.deleteAllItems(agent);
        skuitems.deleteAllSkuItems(agent);      
        skus.deleteAllSkus(agent);
    });
